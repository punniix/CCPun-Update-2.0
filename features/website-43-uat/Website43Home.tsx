    ...
    <div className={styles.root}>
      <main id="main-content">
        ...
        <section className={`${styles.section} ${styles.sectionTopLarge}`}><div className={styles.inner}>
          ...
          <div className={styles.partners} style={{gridTemplateColumns:'repeat(auto-fit,minmax(140px,1fr))'}}><div className={styles.partner}><strong>AIA</strong><span>ตัวแทนประกันชีวิต</span></div><div className={styles.partner}><strong>Maybank</strong><span>ผู้แนะนำการลงทุนอิสระ</span></div><div className={styles.partner}><strong>PhillipCapital</strong><span>ผู้แนะนำการลงทุนอิสระ</span></div><div className={styles.partner}><strong>Finnomena</strong><span>ผู้แนะนำการลงทุนอิสระ</span></div><div className={styles.partner}><div className={`${styles.partnerLogoFrame} ${styles.partnerLogoFrameFairdee}`}><Image className={`${styles.partnerLogo} ${styles.partnerLogoFairdee}`} src="/assets/website-43/fairdee-logo.png" alt="Fairdee" width={512} height={512} /></div><span>ประกันวินาศภัย</span></div><div className={styles.partner}><div className={`${styles.partnerLogoFrame} ${styles.partnerLogoFrameWebull}`}><Image className={`${styles.partnerLogo} ${styles.partnerLogoWebull}`} src="/assets/website-43/webull-logo.png" alt="Webull" width={736} height={736} /></div><span>แพลตฟอร์มการลงทุน</span></div></div>
        </div></section>
