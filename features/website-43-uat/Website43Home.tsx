      ...
      <main id="main-content">
        <section id="home" className={styles.homeHero} aria-labelledby="home-hero-title">
          ...
          <div className={styles.homeHeroCopy}>
            ...
            <h1 id="home-hero-title" className={styles.homeHeroTitle}>เพราะปัญหาทางการเงินมัน<br />ซับซ้อน เราจึงต้องวางแผน ออกแบบให้เหมาะกับตัวคุณ</h1>
        ...
        <section className={`${styles.section} ${styles.sectionTopLarge}`}><div className={styles.inner}>
          ...
          <div className={styles.partners} style={{gridTemplateColumns:'repeat(auto-fit,minmax(140px,1fr))'}}><div className={styles.partner}><strong>AIA</strong><span>ตัวแทนประกันชีวิต</span></div><div className={styles.partner}><strong>Maybank</strong><span>ผู้แนะนำการลงทุนอิสระ</span></div><div className={styles.partner}><strong>PhillipCapital</strong><span>ผู้แนะนำการลงทุนอิสระ</span></div><div className={styles.partner}><strong>Finnomena</strong><span>ผู้แนะนำการลงทุนอิสระ</span></div><div className={styles.partner}><strong>Fairdee</strong><span>ประกันวินาศภัย</span></div><div className={styles.partner}><strong>Webull</strong><span>แพลตฟอร์มการลงทุน</span></div></div>
        </div></section>
