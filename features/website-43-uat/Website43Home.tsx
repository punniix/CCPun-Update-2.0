...
const faqs = [
  { question: 'CCPun คือใคร?', answer: 'CCPun คือผู้ให้คำแนะนำด้านประกันและการลงทุน โดยมีใบอนุญาตตัวแทนประกันชีวิต นายหน้าประกันวินาศภัย และผู้วางแผนการลงทุน และใช้แนวทางวางแผนจากชีวิตจริงก่อนเลือกผลิตภัณฑ์' },
    ...
    <div className={styles.root}>
      <main id="main-content">
        ...
        <section className={`${styles.section} ${styles.trustSection}`}><div className={styles.inner}>
          ...
          <p className={styles.license}>ใบอนุญาต: ตัวแทนประกันชีวิต 6801064783 · ผู้วางแผนการลงทุน 106654 · นายหน้าประกันวินาศภัย 6904009841</p>
