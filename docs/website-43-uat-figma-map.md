...
|---|---|---|---|---|
| 01 Home | `846:737` / `884:843` / `884:999` | `/preview/website-4-3` | `Website43Home` + shared `Website43Navbar` / `Website43Footer` | Match 1440 / 820 / 390 compositions. Desktop hero uses the Figma 1440 composition and anchors the desktop source image left for 1024+ widths so narrower desktop crops do not pull the portrait under the headline. Mobile hero is a distinct composition; About portrait stage is square 400 / 260 / 318 with the subject shifted down inside the crop. No removed Trust Strip. |
