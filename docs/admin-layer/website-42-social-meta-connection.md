...
- Minimum read scopes: `pages_show_list`, `pages_read_engagement`, `instagram_basic`
...
- Provider reads are owner-triggered and return only identity plus recent native counters; no token field, publishing scope, database write, Sanity write, or Production behavior exists in this batch
